...
from tensorflow.keras.layers import (
    Activation, BatchNormalization, Concatenate, Conv3D, Conv3DTranspose,
...
def unet_model_3d(
    ...
    *args
    ...
    for layer_depth in range(depth - 2, -1, -1):
        ...
        concat = c([up_convolution, levels[layer_depth][1]])
...
def create_convolution_block(
    ...
    layer = Conv3D(
        ...
        padding=padding,
        strides=strides,
        name="depth_" + str(layer_depth) + "_conv"
    )(input_layer)
    if batch_normalization:
        layer = BatchNormalization(
            axis=1, name="depth_" + str(layer_depth) + "_bn"
        )(layer)
        ...
        layer = InstanceNormalization(
            axis=1, name="depth_" + str(layer_depth) + "_in"
        )(layer)
